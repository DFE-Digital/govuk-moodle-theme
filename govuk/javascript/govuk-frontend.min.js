...
class ElementError extends GOVUKFrontendError {
  constructor(t) {
    ...
    if ('object' == typeof t) {
      const { component: n, identifier: s, element: i, expectedType: o } = t;
      (e = s),
        (e += i
          ? ` is not of type ${null != o ? o : 'HTMLElement'}`
          : ' not found'),
        (e = formatErrorMessage(n, e));
    }
...
class ConfigurableComponent extends GOVUKFrontendComponent {
  ...
  constructor(e, n) {
    ...
    const i = (function (Component, t) {
      ...
      const e = {};
      for (const [n, s] of Object.entries(Component.schema.properties))
        n in t && (e[n] = normaliseString(t[n], s)),
          'object' === (null == s ? void 0 : s.type) &&
            (e[n] = extractConfigByNamespace(Component.schema, t, n));
      return e;
...
function extractConfigByNamespace(t, e, n) {
  ...
  for (const [o, r] of Object.entries(e)) {
    ...
    for (const [s, i] of e.entries())
      'object' == typeof t &&
        (s < e.length - 1
          ? (isObject(t[i]) || (t[i] = {}), (t = t[i]))
          : o !== n && (t[i] = normaliseString(r)));
  }
  return i[n];
}
class I18n {
  ...
  getPluralSuffix(t, e) {
    ...
    const n = this.translations[t],
      s = this.hasIntlPluralRulesSupport()
    ...
    if ('object' == typeof n) {
      ...
      if ('other' in n)
        return (
          console.warn(
            `i18n: Missing plural form ".${s}" for "${this.locale}" locale. Falling back to ".other".`,
          ),
          'other'
        );
    }
  ...
  constructor(t, e = {}) {
    ...
    const o = (function (t, e) {
      ...
      for (const [s, i] of Object.entries(t)) {
        const t = [];
        if (Array.isArray(i)) {
          for (const { required: n, errorMessage: s } of i)
            n.every((t) => !!e[t]) || t.push(s);
    ...
    (this.i18n = new I18n(this.config.i18n, {
      ...
      (this.maxLength =
        null !=
        (n = null != (s = this.config.maxwords) ? s : this.config.maxlength)
          ? n
          : 1 / 0),
      (this.$textarea = i);
    ...
    (l.className = a.className),
      l.classList.add('govuk-character-count__status'),
      l.setAttribute('aria-hidden', 'true'),
      (this.$visibleCountMessage = l),
...
class ErrorSummary extends ConfigurableComponent {
  ...
  focusTarget(t) {
    ...
    return !!s && (s.scrollIntoView(), n.focus({ preventScroll: !0 }), !0);
  }
...
class SkipLink extends GOVUKFrontendComponent {
  constructor(t) {
    ...
    try {
      ...
      throw new ElementError(
        `Skip link: Target link (\`href="${s}"\`) is invalid`,
      );
    }
    if (
    ...
    if (!o)
      throw new ElementError(
        `Skip link: Target link (\`href="${s}"\`) has no hash fragment`,
      );
...
function initAll(t) {
  ...
  const n = [
    ...
    s = { scope: null != (e = t.scope) ? e : document, onError: t.onError };
...
function createAll(Component, t, e) {
  ...
  var i;
  'object' == typeof e &&
    ((s = null != (i = e.scope) ? i : s), (n = e.onError));
    ...
    ? Array.from(o)
        .map((e) => {
          try {
            ...
            return (
              n
                ? n(s, { element: e, component: Component, config: t })
                : console.log(s),
              null
            );
          }
        ...
        .filter(Boolean)
    : (n
        ? n(new SupportError(), { component: Component, config: t })
        : console.log(new SupportError()),
      []);
}
